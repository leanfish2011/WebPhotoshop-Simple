    ...
    function (options) {
        ...
        function () {
            ...
            if (settings.window.expandable)
                $($this).after('<span class="jPicker"><span class="Icon"><span class="Color">&nbsp;</span><span class="Alpha">&nbsp;</span><span class="Image" title="颜色选择器">&nbsp;</span><span class="Container">&nbsp;</span></span></span>');
            ...
            okClicked =
             ...
             closeClicked =
              function () {
                  revertColor.call($this);
                  settings.window.expandable && hide.call($this);
                  $.isFunction(cancelCallback) && cancelCallback.call($this, color.active, closeButton);
              },
            ...
            show =
              function () {
                  ...
                  if (settings.window.expandable) {
                      $(document.body).children('div.jPicker.Container').css({ zIndex: 3000 });
                      container.css({ zIndex: 4000 });
                  }
            ...
            hide =
              function () {
                  var removeIFrame = function () {
                      if (settings.window.expandable) container.css({ zIndex: 3000 });
                      if (!settings.window.expandable || $.support.boxModel) return;
            ...
            initialize =
              function () {
                  ...
                  if (win.expandable) {
                    ...
                    position: 'absolute',
                    top: win.position.y == 'top' ? (popup.offset().top - 200) + 'px' :
                  ...
                  var hex = all != null ? all.hex : null,
                    ...
                    btnmove = tbody.find('.Move'); //找到class=move下的关闭按钮
                  activePreview = preview.find('.Active:first').css({ backgroundColor: hex && '#' + hex || 'transparent' });
                  currentPreview = preview.find('.Current:first').css({ backgroundColor: hex && '#' + hex || 'transparent' }).bind('click', currentClicked);
                  setAlpha.call($this, currentPreview, Math.precision(color.current.val('a') * 100) / 255, 4);
                  okButton = button.find('.Ok:first').bind('click', okClicked);
                  cancelButton = button.find('.Cancel:first').bind('click', cancelClicked);
                  closeButton = btnmove.find('.Close:first').bind('click', closeClicked); //自己增加的
            ...
            destroy =
              function () {
                  ...
                  coloseButton.unbind('click', closeClicked);
                  if (settings.window.expandable) {
...
$.fn.jPicker.defaults = /* jPicker defaults - you can change anything in this section (such as the clientPath to your images) without fear of breaking the program */
      ...
      color:
        {
            ...
            active: new Color({ ahex: '#000000' }), /* acceptable values are any declared $.jPicker.Color object or string HEX value (e.g. #ffc000) WITH OR WITHOUT the "#" prefix */
      ...
      images:
        {
            clientPath: 'JScript/jpicker-1.1.6/images/', /* Path to image files */
            colorMap:
          {
              width: 256,
              height: 256,
