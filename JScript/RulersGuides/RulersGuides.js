        ...
        Menu = function () {
            ...
            this.render = function () {
                ...
                evt.attach('mousedown', menuBtn, function () {
                    ...
                    toggles.details.txt.nodeValue = (detailsStatus === 0) ? '显示详细信息' : '隐藏详细信息';
                    toggles.snapdom.txt.nodeValue = (snapDom === 0) ? '设置为界面的间隔' : '取消设置为界面的间隔';
